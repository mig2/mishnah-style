# Mishnah Editorial Style Guide

This is the authoritative reference for formatting Mishnah text. Read this entire document before touching any text.
...
3. **Then punctuate and lay out.** Apply the rules below with the structure in mind. Every em-dash placement, every line break, every colon should reflect the mishna's logic.

## 1. Punctuation

Punctuate with a light editorial hand. The goal is clarity and readability, not heavy annotation.
